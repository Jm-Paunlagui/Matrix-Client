...
export default function AdminPrediction() {
  ...
  const get_previous_evaluated_file = () => {
    httpClient
      .get("/data/get-previous-evaluated-file", {
        headers: {
          Authorization: token,
          Cookie: token,
        },
        ...
        <>
          ...
          <div className="grid grid-cols-1 py-8 md:grid-cols-3 gap-y-6 md:gap-6">
            <div className="col-span-1 p-8 rounded-lg bg-blue-50 shadow col-start-2 md:col-start-auto">
              ...
              <p className="mb-4 text-sm text-gray-500 font-medium">
                On the first run, the system will take a long time to analyze
                and save the data. This is because the system is{" "}
                <b className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-teal-500">
                ...
                user&#39;s full name.{" "}
                <b className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-teal-500">
                  but it still depends on the size of the data to analyze and
                  save.
                </b>
              </p>
              <h1 className="mb-4 text-xl font-bold text-blue-500">
              ...
              <p className="mb-4 text-sm text-gray-500 font-medium">
                ...
                ready right through their email. You can manage these accounts
                in the{" "}
                ...
                <div className="grid w-full h-full grid-cols-1 md:grid-cols-5">
                  <div className="flex flex-col w-full h-full col-span-5 p-8 pb-8 space-y-4">
                    ...
                    {count === 1 ? (
                      ...
                      >
                        <div className="p-2 rounded bg-yellow-100 mb-4">
                          <h1 className="text-sm font-medium text-yellow-500">
                            <b>Note:</b> Make sure that the CSV file contains
                            the overall data before uploading. Mismatched data
                            from the previous analyzed CSV file will be
                            rejected. If you want to analyze a new CSV file
                            which contains new set of professors and
                            departments, please archive all/previous the data
                            first.
                          </h1>
                        </div>
                      ...
                      <form onSubmit={handleSubmitToAnalyzeAndSave}>
                        <div className="flex flex-col space-y-4">
                          <p className="text-gray-500">
                            ...
                            sentence. For example, &ldquo;I like the
                            teacher&ldquo;.
                          </p>
                          <div className="flex flex-col w-full space-y-2">
                      ...
                      <div className="flex flex-col space-y-4">
                        <p className="text-gray-500">
                          Why does it take so long? Here&#39;s why: We are using
                          a deep learning model to analyze your data. This model
                          is a neural network that is trained to understand the
                          meaning of your data. This process takes time. We are
                          working on making this process faster.
                        </p>
                        <div className="flex flex-col w-full">
                          <DisclosureTogglable
                            title={
                              "Removed Empty Columns and Text Preprocessing"
                            }
                          >
                            <p className="text-gray-500">
                              We are removing empty columns from your data. This
                              is to make sure that the model does not get
                              confused by empty columns in your data.
                            </p>
                            <p className="text-gray-500">
                              ...
                              multiple_whitespaces (also at the beginning and
                              end of the response) ,special_characters, urls,
                              emails, html tags.
                            </p>
                        ...
                        <div className="flex flex-col w-full">
                          <DisclosureTogglable title={"Tokenization"}>
                            <p className="text-gray-500">
                              Neural networks utilize numbers as their inputs,
                              so we need to convert our input text into numbers.
                            </p>
                            <p className="text-gray-500">
                              Tokenization is the process of converting text
                              into tokens. A token is a sequence of characters
                              or a substring of the text. In our trained model,
                              we used its own tokenizer to tokenize the text to
                              avoid any mismatch in the tokens.
                            </p>
                            <div className="content-end flex flex-wrap justify-start w-full gap-2">
                              <div className="bg-white p-2 rounded-lg">
                                <h1 className="text-base font-medium text-blue-500">
                        ...
                        <div className="flex flex-col w-full">
                          ...
                          >
                            <p className="text-gray-500">
                              We need to make sure that all the sequences are of
                              the same length. This is because neural networks
                              cannot process inputs of different lengths.
                            </p>
                            <p className="text-gray-500">
                              It is required to pad the sequences with zeros to
                              make them of the same length and truncate the
                              sequences that are longer than the maximum length
                              of the sequence. We have used a maximum length of
                              300.
                            </p>
                            <div className="content-end flex flex-wrap justify-start w-full gap-2">
                              <div className="bg-white p-2 rounded-lg">
                        ...
                        <div className="flex flex-col w-full">
                          <DisclosureTogglable title={"Loading the Model"}>
                            <p className="text-gray-500">
                              ...
                              trained model into the memory. This is done to
                              make the model ready for inference.
                            </p>
                            <p className="text-gray-500">
                              Inference is the process of predicting the output
                              of the model. In our case, the model is predicting
                              the meaning of the text. This process takes time
                              because the model is large in size.
                            </p>
                            <div className="content-end flex flex-wrap justify-start w-full gap-2">
                              <div className="bg-white p-2 rounded-lg">
                                <h1 className="text-base font-medium text-blue-500">
                        ...
                        <div className="flex flex-col w-full">
                          ...
                          >
                            <p className="text-gray-500">
                              ...
                              predicting the meaning of the text using the
                              trained model.
                            </p>
                            <p className="text-gray-500">
                              We are also using a threshold of 0.5 to filter out
                              the predictions that are less than 0.5. This is
                              done to make sure that the predictions are
                              accurate.
                            </p>
                            <p className="text-gray-500">
                        ...
                        <div className="flex flex-col w-full">
                          ...
                          >
                            <p className="text-gray-500">
                              We are writing the predictions to a CSV file to
                              easily add the predictions to the database.
                            </p>
                            <p className="text-gray-500">
                              Additionally, we are also computing the converted
                              sentiment, removal of stop words, response length,
                              word count, and polarity to save them in the
                              database.
                            </p>
                            <div className="content-end flex flex-wrap justify-start w-full gap-2">
                              <div className="bg-white p-2 rounded-lg">
                        ...
                        <div className="flex flex-col w-full">
                          ...
                          >
                            <p className="text-gray-500">
                              We are adding the predictions to the database.
                              This is done to make sure that the predictions are
                              saved for future use. Additionally, we are also
                              adding the converted sentiment, removal of stop
                              words, response length, word count, and polarity
                              to the database.
                            </p>
                            <div className="content-end flex flex-wrap justify-start w-full gap-2">
                              <div className="bg-white p-2 rounded-lg">
                        ...
                        <div className="flex flex-col w-full">
                          ...
                          >
                            <p className="text-gray-500">
                              ...
                              creating a user account for you. This is done to
                              make sure that you can access your predictions in
                              the future. You can manage these accounts in the{" "}
                        ...
                        <div className="flex flex-col w-full">
                          ...
                          >
                            <p className="text-gray-500">
                              ...
                              make sure that you can access the department
                              analysis in the future. You can access the
                              department analysis in the{" "}
                              <span className="text-blue-500 font-medium">
                        ...
                        <div className="flex flex-col w-full">
                          ...
                          >
                            <p className="text-gray-500">
                              This process also takes time because it compiles
                              each professor&#39;s courses and responses into
                              there own respective database. This is done to
                              make sure that the professor can access their
                              predictions in the future. You can access the
                              collection provider analysis in the{" "}
                              <span className="text-blue-500 font-medium">
                                <Link to={"/admin/management/files/data"}>
                                  File Management
                                </Link>
