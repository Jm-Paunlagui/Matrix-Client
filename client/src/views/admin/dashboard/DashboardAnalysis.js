...
export default function DashboardAnalysis() {
  ...
  const get_file_details = () => {
    if (isAuth().verified_email === "Verified") {
      httpClient
        .get(`/analysis/dashboard-data-csv/${cookie}`)
        .then((response) => {
          setData({
            ...data,
            loading: false,
  ...
  const loadPolarityVsentiment = (
    ...
    if (isAuth().verified_email === "Verified") {
      ...
      httpClient
        .get(
          `/analysis/sentiment_vs_polarity/${school_year}/${school_semester}/${csv_question}/${cookie}`,
        )
        .then((response) => {
          setAnalysis({
            ...analysis,
            ...
            <div className="flex flex-col items-start w-full p-4 bg-blue-50 rounded-lg shadow space-y-2">
              <div className="w-full z-30">
                ...
                <DisclosureTogglable title="What are Sentiment and Polarity?">
                  <p className="text-base font-medium text-gray-500 mb-4">
                    Sentiment refers to the emotional or attitudinal content of
                    a piece of text, such as a statement, review, or social
                    media post. It is the overall feeling or attitude expressed
                    in the text.
                  </p>
                  <p className="text-base font-medium text-gray-500 mb-4">
                    Polarity, on the other hand, is a measure of the positivity
                    or negativity of a piece of text. It is typically calculated
                    by analyzing the words and phrases used in the text and
                    assigning a positive or negative score to each one. The
                    overall polarity of the text is then determined by summing
                    up these scores.
                  </p>
                </DisclosureTogglable>
              </div>
              <div className="flex flex-col items-start justify-start w-full p-4 rounded-lg space-y-2">
                {loading_analysis ? (
                  ...
                  <>
                    ...
                    />
                    <p className="text-base font-medium text-gray-500 mb-4">
                      Polar words and phrases are usually associated with strong
                      or clearly defined sentiment, while non-polar refers to
                      words and phrases typically used in everyday.
                    </p>
                  </>
                )}
              </div>
            ...
            <div className="flex flex-col items-start w-full p-4 bg-blue-50 rounded-lg shadow space-y-2">
              <div className="w-full z-30">
                ...
                <DisclosureTogglable title="What are Sentiment and Response Length?">
                  <p className="text-base font-medium text-gray-500 mb-4">
                    The length of the responses is a good indicator of the
                    amount of detail the students have provided in their
                    responses. The longer the response, the more detail the
                    student has provided.
                  </p>
                  <p className="text-base font-medium text-gray-500 mb-4">
                    The sentiment of the responses is also a good indicator of
                    the amount of detail the students have provided in their
                    responses. The more positive the sentiment, the more detail
                    the student has provided but sometimes the sentiment can be
                    negative but the response is still detailed.
                  </p>
                </DisclosureTogglable>
              </div>
              <div className="flex flex-col items-start justify-start w-full p-4 rounded-lg space-y-2">
                {loading_analysis ? (
                  ...
                  <>
                    ...
                    <p className="text-base font-medium text-gray-500 mb-4">
                      ...
                      responses are usually short and positive. When the
                      students are unhappy with there professor, the responses
                      are usually long and negative.
                    </p>
                  </>
                )}
              </div>
            ...
            <div className="flex flex-col items-start w-full p-4 bg-blue-50 rounded-lg shadow space-y-2">
              <div className="w-full z-30">
                ...
                <DisclosureTogglable title="What is a Word Cloud?">
                  <p className="text-base font-medium text-gray-500 mb-4">
                    A word cloud is a visual representation of the frequencies
                    of words in a given text or set of texts. It is typically
                    created by displaying each word in the text as a separate
                    label in a font size proportional to its frequency. The more
                    frequently a word appears in the text, the larger it is
                    displayed in the word cloud.
                  </p>
                  <p className="text-base font-medium text-gray-500 mb-4">
                    Word clouds can be useful for quickly visualizing the most
                    common words in a text and identifying trends or patterns.
                    They are often used in sentiment analysis as a way of
                    summarizing the overall sentiment of a text or group of
                    texts.
                  </p>
                </DisclosureTogglable>
              </div>
              <div className="flex flex-col items-start justify-start w-full p-4 rounded-lg space-y-2">
                {loading_analysis ? (
                  ...
                  <>
                    ...
                    />
                    <p className="text-base font-medium text-gray-500 mb-4">
                      The word cloud shows the most common words in the
                      responses. The larger the word, the more common it is.
                    </p>
                  </>
                )}
              </div>
            ...
            <div className="w-full z-30">
              ...
              <DisclosureTogglable title="What are Trigrams?">
                <p className="text-base font-medium text-gray-500 mb-4">
                  ...
                  text. Trigrams are often used in natural language processing
                  and linguistics to analyze the frequencies and patterns of
                  words in a text.
                </p>
                <p className="text-base font-medium text-gray-500 mb-4">
                  By analyzing the trigrams, we can see the most common phrases
                  that students use in their responses.
                </p>
              </DisclosureTogglable>
            </div>
            ...
            <div className="w-full z-30">
              ...
              <DisclosureTogglable title="What are Bigrams?">
                <p className="text-base font-medium text-gray-500 mb-4">
                  ...
                  linguistics to analyze the frequencies and patterns of words
                  in a text.
                </p>
                <p className="text-base font-medium text-gray-500 mb-4">
                  By analyzing the bigrams, we can see the most common phrases
                  used by students in their responses.
                </p>
              </DisclosureTogglable>
            </div>
            ...
            <div className="w-full z-30">
              ...
              <DisclosureTogglable title="What are unigrams?">
                <p className="text-base font-medium text-gray-500 mb-4">
                  ...
                  used in natural language processing and linguistics to analyze
                  the frequencies and patterns of words in a text.
                </p>
                <p className="text-base font-medium text-gray-500 mb-4">
                  By analyzing the unigrams, we can see the most common words
                  used by students in their responses.
                </p>
              </DisclosureTogglable>
            </div>
