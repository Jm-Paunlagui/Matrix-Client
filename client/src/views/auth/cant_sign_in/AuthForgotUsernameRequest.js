...
const {buttonDisabled, email, code, textChange, textChange2 } =
  ...
  const handle2FAFormSubmit = async (event) => {
    ...
    await httpClient
      ...
      .then((response) => {
        ...
        setResetForm({ ...resetForm, textChange: "Next", textChange2: "Resend Code" });
        setOki(false);
      })
      .catch((error) => {
        setErrorEffect(true);
            ...
            <div className="w-11/12 md:w-7/12 lg:w-6/12 xl:w-5/12">
              ...
              <div className="py-12 bg-blue-50 rounded-lg shadow">
                ...
                <div className="px-6 space-y-6 text-center text-gray-500">
                  <p className="text-lg">
                    We&#39;ve sent you an email with your username. Please check your inbox.
                  </p>
                  <p className="text-lg">
                      ...
                      <div className="flex-auto mb-24 space-y-6 -mt-14">
                          ...
                          <div className="mb-3 text-start">
                            {count === 1 ? (
                              ...
                              <p className="text-gray-500">
                                Enter the code we sent to your email below and proceed to the next step.
                              </p>
                            )}
                            {count === 1 ? (
                                    <form
